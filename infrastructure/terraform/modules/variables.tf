...
# ecr image variables (used by K8s manifests, kept for ECR repo creation)
variable "image_name1" {
  description = "the reader service docker image name"
  type        = string
}

variable "image_name2" {
  description = "the writer service docker image name"
  type        = string
}
